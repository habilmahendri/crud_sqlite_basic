...
public class MainActivity extends AppCompatActivity {
    ...
    //Method pengaksesan dan penampilan data
    public void RefreshList() {
        SQLiteDatabase db = dbcenter.getReadableDatabase();
        cursor = db.rawQuery("SELECT * FROM biodata", null); //Cursor berguna Query untuk pemanggilan/perrintah data
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        switch (item) {
                            ...
                            case 2:
                                ...
                                db.execSQL("delete from biodata where nama = '" + selection + "'"); //Syntax untuk menghapus database
                                RefreshList();
                                break;
                        }
                    }
